...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gwc7zhm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gwc7zhm.containers.anotherwebservice.com/
...
```
git clone git@github.com:gtdminh/container-gwc7zhm.git
cd container-gwc7zhm
```
...
```
docker attach container-gwc7zhm
```
